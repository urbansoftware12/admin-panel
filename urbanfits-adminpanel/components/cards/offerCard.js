...
export default function OfferCard(props) {
    return <Link {...props} className='relative w-full h-[20vh] md:h-[30vh] lg:h-[40vh] py-[2vh] flex flex-col justify-center items-center bg-gray-100 rounded-2xl gap-y-2 md:gap-y-7 lg:gap-y-8 overflow-hidden'>
        <span className="absolute top-0 left-0 bg-black px-3 md:px-4 py-1 md:py-2 font_urbanist text-white text-[10px] md:text-sm lg:text-base rounded-br-2xl">{props.badge}</span>
        ...
        <span className="font_urbanist_medium underline md:text-2xl lg:text-3xl 2xl:text-4xl">Shope Now</span>
    </Link>
}